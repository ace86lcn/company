...
<script>
    ...
    import { SendForgetCode, CheckForgetCode, ChangeAccountPwd } from '@/api/common'
    export default {
        data() {
            return {
                pwd: '',               //密码
        ...
        methods: {
            ...
            startLow() {
                ...
                this.$http(SendForgetCode, { mobile: this.mobile })
                .then(res => {
